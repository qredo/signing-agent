...
**Note:** an always up to date API documentation can be accessed within the (private) [Gitlab repo](https://gitlab.qredo.com/computational-custodian/signing-agent/-/blob/master/docs/swagger/swagger.yaml).
